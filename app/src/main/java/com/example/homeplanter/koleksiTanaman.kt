...
object koleksiTanaman {
    private val NamaTanaman = arrayOf("Bunga Alamanda",
        "Cemara Laut",
        "Kaktus Ariocarpus",
        "Palem Raja",
        "Bunga Amarilis",
    ...
    private val GambarTanaman = intArrayOf(R.drawable.bunga_alamanda,
    ...
    private val NamaLatin = arrayOf("Allamanda cathartica",
    ...
    private val HargaTanaman = arrayOf("Rp. 20.000",
    "Rp. 28.500",
    "Rp. 975.000",
    "Rp. 23.500",
    "Rp. 20.000",
    ...
    private val asalTanaman = arrayOf("Kab. Tangerang",
    "Kota Batu",
    "Kota Denpasar",
    "Kota Batu",
    "Kota Malang",
    ...
    private val iklim = arrayOf("Dataran Rendah",
    "Dataran Rendah s/d Tinggi",
    "Dataran Rendah s/d Tinggi",
    "Dataran Rendah s/d Tinggi",
    "Dataran Rendah s/d Tinggi",
    "Dataran Rendah s/d Tinggi",
    ...
    private val matahari = arrayOf("Penyinaran Sepanjang Hari",
